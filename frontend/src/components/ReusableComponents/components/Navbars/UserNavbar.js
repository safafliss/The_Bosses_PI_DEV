      ...
      <>
        <div className="mx-auto max-w-7xl px-2 sm:px-6 lg:px-8">
          <div className="relative flex h-16 items-center justify-between">
                  ...
                  {navigation.map((item) => (
                    <a
                      ...
                      className={classNames(
                        item.current ? ' no-underline bg-green-600 text-white my-4' : 'no-underline text-green-600 hover:bg-green-600 hover:text-black my-4',
            ...
            <div className="dropdown mt-6" style={{ display: "block !important" }}>
                    <button
            ...
            <div className="absolute inset-y-0 right-0 flex items-center pr-2 sm:static sm:inset-auto sm:ml-6 sm:pr-0">
              <div>
               ...
               <br></br>
               <h8>{user1?.provider === 'facebook' ? user1?.displayName:user1?.firstName+' '+user1?.lastName}</h8>        
               </div>
              {/* Profile dropdown */}
