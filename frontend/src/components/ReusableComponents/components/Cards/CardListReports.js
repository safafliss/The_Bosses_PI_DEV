...
export default function CardListReports({ color }) {
  ...
  const handleClick = (_id) => {
      ...
      axios
        .delete(`http://localhost:3600/support/deleteReport/${_id}`)
        .then(() => {
 ...
 const updateToTreated = (_id) => {
    ...
    axios
      .put(`http://localhost:3600/support/updateReport/${_id}`,{state:"treated"})
      .then((res) => {
 ...
 const updateNotTreated = (_id) => {
        ...
        axios
          .put(`http://localhost:3600/support/updateReport/${_id}`,{state:"not treated"})
          .then((res) => {
            const updatedReport = res.data;
            setReports(
              Reports.map((report) =>
...
useEffect(() => {
    axios
      .get("http://localhost:3600/support/getAllReports")
      .then((response) => {
