...
function Stat() {
   ...
   const [ratings, setRatings] = useState([]);
    ...
    useEffect(() => {
        axios
          .get("http://localhost:3600/rate/getstarRating")
          .then((response) => {
        ...
        <div className="block w-full overflow-x-auto">
          ...
          <table className="items-center w-full bg-transparent border-collapse">
            ...
            <tbody>
                ...
                <div style={{ display:"flex",justifyContent:"center",flexDirection:"row"}}>{ratings.map((item,index)=>(<img src={img} />))} </div>
                <div style={{ marginLeft:"110px",heigh:"300px",width:"300px",paddingBottom:"120px"}}>
