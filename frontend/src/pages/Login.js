    ...
    <>
      ...
      <div className="container mx-auto px-4 h-full" style={{
        ...
        <div className="flex content-center items-center justify-center h-full">
          <div className="w-full lg:w-4/12 px-4"style={{
            ...
            <div className="relative flex flex-col min-w-0 break-words w-full mb-6 shadow-lg rounded-lg bg-blueGray-200 border-0">
              ...
              <div className="flex-auto px-4 lg:px-10 py-10 pt-0">
                ...
                <form onSubmit={onSubmit}>
                  ...
                  <FontAwesomeIcon style={{ cursor:"pointer"}}icon={faRedoAlt} onClick={handleRegenerate}/>
                 <input style={{color:"black"}}type="text" name="code" placeholder="Enter the code above" />
                </div>
