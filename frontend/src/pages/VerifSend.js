          ...
          <div className="content">
            <div className="wrapper-1 relative flex flex-col min-w-0 break-words w-full mb-6 shadow-lg rounded-lg bg-blueGray-200 border-0">
              <div className="wrapper-2">
                ...
                <button
                  onClick={goHome}
                  className="go-home bg-blueGray-800 text-white active:bg-blueGray-600 text-sm font-bold uppercase px-6 py-3 rounded shadow hover:shadow-lg outline-none focus:outline-none mr-1 mb-1 w-full ease-linear transition-all duration-150"
                >
                  go home
                </button>
              </div>
