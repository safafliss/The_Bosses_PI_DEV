...
const RecipeDetails = () => {
  ...
  // const [selectedColor, setSelectedColor] = useState(recipe.name)
  // const [selectedSize, setSelectedSize] = useState(recipe.preparation)
      ...
      <div className="pt-6">
        ...
        <div className="mx-auto max-w-2xl px-4 pb-16 pt-10 sm:px-6 lg:grid lg:max-w-7xl lg:grid-cols-3 lg:grid-rows-[auto,auto,1fr] lg:gap-x-8 lg:px-8 lg:pb-24 lg:pt-16">
          <div className="lg:col-span-2 lg:border-r lg:border-gray-200 lg:pr-8">
            <h1 className="text-2xl font-bold tracking-tight text-gray-900 sm:text-3xl">{recipe.name}</h1>
          </div>

          {/* Options */}
          <div className="mt-4 lg:row-span-3 lg:mt-0">
            <h2 className="sr-only">recipe information</h2>
            <p className="text-3xl tracking-tight text-gray-900">{recipe.preparation}</p>
          ...
          <div className="py-10 lg:col-span-2 lg:col-start-1 lg:border-r lg:border-gray-200 lg:pb-16 lg:pr-8 lg:pt-6">
            ...
            <div>
              ...
              <div className="space-y-6">
                <p className="text-base text-gray-900">{recipe.cooking}</p>
              </div>
            </div>
