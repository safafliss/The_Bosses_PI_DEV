              ...
              <div className="flex-auto px-4 lg:px-10 py-10 pt-0">
                ...
                <form method="POST" class="register-form" id="register-form"onSubmit={onSubmit}>
                  <div className="relative w-full mb-3">
                    ...
                    <Inputs
                     name="firstName" type="text" placeholder="Your firstName" onChangeHandler={onChangeHandler}  errors={errors.firstName}
                  ...
                  <div className="relative w-full mb-3">
                    ...
                    <Inputs
                     name="lastName" type="text" placeholder="Your lastName" onChangeHandler={onChangeHandler}  errors={errors.lastName}
                      className="border-0 px-3 py-3 placeholder-blueGray-300 text-blueGray-600 bg-white rounded text-sm shadow focus:outline-none focus:ring w-full ease-linear transition-all duration-150"
                  ...
                  <div className="relative w-full mb-3">
                    ...
                    <Inputs
                     name="email" type="text" placeholder="Your Email" onChangeHandler={onChangeHandler}  errors={errors.email}
                      className="border-0 px-3 py-3 placeholder-blueGray-300 text-blueGray-600 bg-white rounded text-sm shadow focus:outline-none focus:ring w-full ease-linear transition-all duration-150"
                  ...
                  <div className="relative w-full mb-3">
                    ...
                    <Inputs
                  name="password"    type="password"  placeholder="Password" onChangeHandler={onChangeHandler}  errors={errors.password}                      className="border-0 px-3 py-3 placeholder-blueGray-300 text-blueGray-600 bg-white rounded text-sm shadow focus:outline-none focus:ring w-full ease-linear transition-all duration-150"
                  ...
                  <div className="relative w-full mb-3">
                    ...
                    <Inputs
                    name="confirm"  type="password" placeholder="Repeat your password" onChangeHandler={onChangeHandler}  errors={errors.confirm}                  
                    className="border-0 px-3 py-3 placeholder-blueGray-300 text-blueGray-600 bg-white rounded text-sm shadow focus:outline-none focus:ring w-full ease-linear transition-all duration-150"
            ...
            An association
                  ...
                  <div className="text-center mt-6">
                    ...
                    type="submit" 
                      ...
                      name="signup" id="signup"value="Register"
                    >
                      Create Account
                    </button>
                  </div>
